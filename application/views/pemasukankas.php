<div class="content-wrapper">
    <section class="content">
      ...
      <h2 class="pt-3 pb-2 text-white"><?= $title; ?></h2>
            ...
            <div class="card">
                <div class="card-body">
                    <form method="get" action="<?= base_url('pemasukankas') ?>" class="mb-3">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <table class="table table-bordered table-striped">
                                    ...
                                    <?php foreach ($grouped_transaksi as $groupKey => $transaksis): ?>
                                        ...
                                        <?php foreach ($transaksis as $tr): ?>
                                            <tr>
                                                ...
                                                <td class="text-right"><?= ($tr->jenis_saldo == 'debit') ? 'Rp ' . number_format($tr->jumlah, 0, ',', '.') : '-' ?></td>
                                                <td class="text-right"><?= ($tr->jenis_saldo == 'kredit') ? 'Rp ' . number_format($tr->jumlah, 0, ',', '.') : '-' ?></td>
                                            </tr>
                                            <?php
                                ...
                                <tfoot>
                                    <tr>
                                        <td colspan="4" class="text-center font-weight-bold">TOTAL PEMASUKAN KAS</td>
